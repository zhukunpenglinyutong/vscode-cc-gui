    ...
    >
      ...
      <div className="card-header" onClick={onToggleExpand}>
        <div className="header-left-section">
          ...
          {!isCodexMode && (
            <span className={`scope-badge scope-${server.scope === 'local' ? 'local' : 'user'}`}>
              {server.scope === 'local' ? t('mcp.serverDialog.scope.badgeLocal') : t('mcp.serverDialog.scope.badgeUser')}
            </span>
          )}
